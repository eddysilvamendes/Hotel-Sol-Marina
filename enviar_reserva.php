...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'edilson.mendes@primeconsulting.org' =>
            ['#subject#' => 'Hotel Sol Marina Reservation Request',
    ...
    try {
        ...
        $image_logo = $message->embed(Swift_Image::fromPath('img/logo2.png'));
